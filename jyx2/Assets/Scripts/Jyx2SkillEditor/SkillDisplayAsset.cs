...
public partial class SkillDisplayAsset : ConfigBase
{
    ...
    public static SkillDisplayAsset Get(string skillName)
    {
        //为了在编辑器下所见即所得，所以在editor下直接载入
#if UNITY_EDITOR
        var clip = AssetDatabase.LoadAssetAtPath<SkillDisplayAsset>($"Assets/BuildSource/Configs/SkillDisplays/{skillName}.asset");
        return clip;
#else
