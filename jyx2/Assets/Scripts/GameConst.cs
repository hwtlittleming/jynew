...
public class GameConst
{
    ...
    public static Dictionary<string, PropertyItem> ProItemDic = new Dictionary<string, PropertyItem>()
    {
        ...
        //---------------------------------------------------------------------------
        ["1"] = new PropertyItem(1, "MaxMp", "能量".GetContent(nameof(GameConst)), 40, 30),//创角用到 特殊
        ["2"] = new PropertyItem(2, "Attack", "攻击".GetContent(nameof(GameConst)), 30, 20),//创角用到 特殊
        ["3"] = new PropertyItem(3, "Speed", "速度".GetContent(nameof(GameConst)), 30, 20),
